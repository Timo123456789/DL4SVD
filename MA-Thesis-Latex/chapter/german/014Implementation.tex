...
Die genutzte Programmiersprache ist Python. Die Scripte für \acrshort{PALMA} wurden in Bash geschrieben.
...
Verwendet wurde ein vortrainiertes Modell auf dem \acrshort{DOTA}-Datensatz\todo{Referenz zum \acrshort{DOTA}-Datensatz einfügen}, wobei die Modellarchitektur \texttt{YOLOv9u}\todo{Referenz zur YOLOv9u-Architektur einfügen} durchgängig zum Einsatz kam.
