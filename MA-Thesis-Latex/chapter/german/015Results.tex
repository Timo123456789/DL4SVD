...
\todo{Tabelle gleich zu \ref{tab:best_map_fold_perm_exp} machen }
\begin{table}[h]
\centering
\begin{tabular}{l c c}
\hline
...
\begin{figure}[htbp]
    ...
    \caption[Difference Matrices compared to RGBIR (Fold 2)]{Difference Matrices for all models compared against RGBIR (Fold 2). Red indicates better performance for RGBIR, blue for the respective comparison model.}
...
\begin{tabular}{c|ccccccc}
    ...
    %Car
    & \includegraphics[trim={1460pt 1740pt 310pt 30pt},clip,width=\textwidth/10]{"C:/Users/timol/OneDrive - Universität Münster/14. Fachsemester_SS_24/Palma_Runs/new_val_detect/ir/fold0/val_at_test/val_batch0_labels.jpg"}
    %Truck
    ...
    %Pick Up
    & \includegraphics[trim={120pt 200pt 1590pt 1510pt},clip,width=\textwidth/10]{"C:/Users/timol/OneDrive - Universität Münster/14. Fachsemester_SS_24/Palma_Runs/new_val_detect/ir/fold0/val_at_test/val_batch2_labels.jpg"}
    %Camping Car
    ...
    %Plane
    & \includegraphics[trim={1100pt 1100pt 600pt 600pt},clip,width=\textwidth/10]{"C:/Users/timol/OneDrive - Universität Münster/14. Fachsemester_SS_24/Palma_Runs/new_val_detect/ir/fold0/val_at_test/val_batch1_labels.jpg"}
    %vehicle
